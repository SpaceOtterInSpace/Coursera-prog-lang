...
Put your testing code in a second file. We will not grade it, but you must turn it in.
Assessment
...
Follow the instructions on the course website to submit your assignment twice, once for auto-grading and
once for peer assessment. The instructions are analogous to the instructions for the previous assignment.
4